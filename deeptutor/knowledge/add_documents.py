...
from deeptutor.knowledge.extract_numbered_items import process_content_list
from deeptutor.logging import LightRAGLogContext, get_logger
...
from deeptutor.services.llm.config import get_llm_config as _early_config_load  # noqa: F401
...
class DocumentAdder:
    ...
    async def _process_raganything(
        ...
        from deeptutor.services.llm import get_llm_client
        from deeptutor.services.rag.components.routing import FileTypeRouter
        from deeptutor.services.rag.utils.image_migration import (
...
Example usage:
  ...
  python -m deeptutor.knowledge.add_documents my_kb --docs doc1.pdf doc2.txt

  # Add all documents from a directory
  python -m deeptutor.knowledge.add_documents my_kb --docs-dir ./documents/
        """,
    )
