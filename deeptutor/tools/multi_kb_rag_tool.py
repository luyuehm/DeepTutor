...
from deeptutor.core.core import get_embedding_config, get_llm_config, get_rerank_config, load_config_with_main
from deeptutor.core.logging import LightRAGLogContext, get_logger
...
async def multi_kb_rag_search(
    ...
    **kwargs,
    ...
    if kb_base_dir is None:
        kb_base_dir = str(_path_service.project_root / "data" / "knowledge_bases")
