...
The \textit{Hybrid Personalization Engine} (\S\ref{sec:personalization}) couples a static knowledge grounding with a dynamic memory that maintains an evolving learner profile.
