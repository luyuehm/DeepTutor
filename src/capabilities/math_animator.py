...
from src.core.trace import build_trace_metadata, merge_trace_metadata, new_call_id
...
class MathAnimatorCapability(BaseCapability):
    ...
    async def run(self, context: UnifiedContext, stream: StreamBus) -> None:
        from src.agents.math_animator.pipeline import MathAnimatorPipeline
        from src.agents.math_animator.request_config import (
