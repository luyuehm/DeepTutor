"""Helpers for rendering tool prompt hints into capability-specific prompt text."""

from __future__ import annotations

from collections import OrderedDict

from src.core.tool_protocol import ToolPromptHints
        ...
        for name, hint in hints:
            ...
            if hint.aliases:
                for alias in hint.aliases:
                    ...
                    alias_text = alias.when_to_use or alias.description or hint.guideline or hint.short_description
                    if alias_text:
