...
from src.core.capability_protocol import BaseCapability
from src.runtime.bootstrap.builtin_capabilities import BUILTIN_CAPABILITY_CLASSES
...
def _load_plugin_hooks():
    try:
        module = importlib.import_module("src.plugins.loader")
    except Exception:
